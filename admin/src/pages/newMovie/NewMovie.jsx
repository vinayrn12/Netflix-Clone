        ...
        <div className="newProduct">
            ...
            <form className="addProductForm">
                ...
                <div className="addProductItem">
                    ...
                    <input type='text' placeholder='John Wick is an American neo-noir action thriller media franchise created by screenwriter Derek Kolstad and owned by Lionsgate.' name='desc' onChange={handleChange} />
                </div>
                <div className="addProductItem">
                    <label>Year</label>
                    <input type='text' placeholder='2014' name='year' onChange={handleChange} />
                </div>
                <div className="addProductItem">
                    <label>Genre</label>
                ...
                <div className="addProductItem">
                    ...
                    <input type='text' placeholder='1hr 44 min' name='duration' onChange={handleChange} />
                </div>
                <div className="addProductItem">
                    <label>Limit</label>
                ...
                </div>
                {
                    uploaded === 5 ? (
                        ...
                        <button onClick={handleUpload} className="addProductButton">Upload</button>
                    )
                }
            </form>
        </div>
